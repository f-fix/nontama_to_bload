...
This tool was initially created in order to understand whether the Itasundorious tape was damaged. It has since been used successfully with Itasundorious, Cannon Ball, and Dimensional Wars, Punchball Mario, Salad no Kuni no Tomato-hime, Yakyuukyou, and the first chapter of Dezeni Land (might work for the remaining chapters too, ; it gets far enough to ask for your save tape at least...)
