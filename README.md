...
This tool was initially created in order to understand whether my Itasundorious tape was damaged (it wasn't, or rather the damage happened before the tape was written.) It has since been used successfully with Itasundorious, Cannon Ball, Dimensional Wars, Punchball, Salad no Kuni no Tomato-hime, Yakyuukyou, and the first chapter of Dezeni Land (might work for the remaining chapters too; it gets far enough to ask for your save tape at least...)
